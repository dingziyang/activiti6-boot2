...
////
  ...
  public AppDefinitionRepresentation getAppDefinitionByNone() {
    return createAppDefinitionRepresentation(new Model());
  }
  @RequestMapping(value = "/rest/runtime/app-definitions/{deploymentKey}", method = RequestMethod.GET, produces = "application/json")
  public AppDefinitionRepresentation getAppDefinitionByDeploymentKey(@PathVariable("deploymentKey") String deploymentKey) {
    Model model = modelService.getModel(deploymentKey);
