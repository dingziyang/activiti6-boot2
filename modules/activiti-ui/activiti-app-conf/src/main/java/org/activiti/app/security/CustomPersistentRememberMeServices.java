...
//        System.out.println("---------Creating new persistent login for user {}:"+ userEmail);
//        System.out.println("---------用户身份信息对象：" + successfulAuthentication.getPrincipal().toString());
//        System.out.println("---------用户身份信息对象json：" +
//                ToStringBuilder.reflectionToString(successfulAuthentication.getPrincipal(), ToStringStyle.SHORT_PREFIX_STYLE));
