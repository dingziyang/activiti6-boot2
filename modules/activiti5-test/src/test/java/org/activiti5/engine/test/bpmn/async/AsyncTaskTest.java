...
public class AsyncTaskTest extends PluggableActivitiTestCase {
  ...
  public void testAsyncScript() {  
    ...
    runtimeService.signalEventReceived(eid);        
  }
  
  @Deployment(resources={"org/activiti5/engine/test/bpmn/async/AsyncTaskTest.testAsyncCallActivity.bpmn20.xml", 
          "org/activiti5/engine/test/bpmn/async/AsyncTaskTest.testAsyncServiceNoListeners.bpmn20.xml"})
  ...
  @Deployment(resources = {"org/activiti5/engine/test/bpmn/async/AsyncTaskTest.testBasicAsyncCallActivity.bpmn20.xml",
            "org/activiti5/engine/test/bpmn/StartToEndTest.testStartToEnd.bpmn20.xml"})
