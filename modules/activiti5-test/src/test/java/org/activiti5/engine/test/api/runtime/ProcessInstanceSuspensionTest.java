...
public class ProcessInstanceSuspensionTest extends PluggableActivitiTestCase {
  ...
  @Deployment(resources={
          "org/activiti5/engine/test/api/runtime/superProcessWithMultipleNestedSubProcess.bpmn20.xml",
          "org/activiti5/engine/test/api/runtime/nestedSubProcess.bpmn20.xml",
  ...
  @Deployment(resources = "org/activiti5/engine/test/api/runtime/ProcessInstanceSuspensionTest.testSignalEventReceivedAfterProcessInstanceSuspended.bpmn20.xml")
