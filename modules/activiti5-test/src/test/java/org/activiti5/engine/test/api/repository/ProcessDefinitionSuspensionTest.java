...
public class ProcessDefinitionSuspensionTest extends PluggableActivitiTestCase {
  ...
  @Deployment(resources={"org/activiti5/engine/test/db/processOne.bpmn20.xml"})
  ...
  @Deployment(resources={
          "org/activiti5/engine/test/db/processOne.bpmn20.xml",
          "org/activiti5/engine/test/db/processTwo.bpmn20.xml"
          })
