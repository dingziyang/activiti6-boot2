...
package org.activiti5.camel.exception;
...
public class CamelExceptionTest extends SpringActivitiTestCase {
  ...
  @Deployment(resources = { "org/activiti5/camel/exception/bpmnExceptionInRouteSynchronous.bpmn20.xml" })
  ...
  @Deployment(resources = { "org/activiti5/camel/exception/bpmnExceptionInRouteAsynchronous.bpmn20.xml" })
